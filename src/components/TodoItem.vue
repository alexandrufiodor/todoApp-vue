<template>
  <li class="list-item">
    ...
    <div>
      ...
      <button class="button edit"
              v-on:click="itemEdit(newTitle, todo.id)" v-else>
        <font-awesome-icon icon="fa-solid fa-square-check" class="icon"/>
      </button>
      <button class="button remove"
              v-on:click="itemRemove(todo)">
